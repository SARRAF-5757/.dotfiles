...
# Optional parameters:
# @raycast.icon https://f-droid.org/repo/com.shabinder.spotiflyer/en-US/icon_thUbhx0uJAq4WiC069oqFjah8QZ5feyfQx2Hn3zj8mQ=.png

# Documentation:
# @raycast.description Silence spotify ads
